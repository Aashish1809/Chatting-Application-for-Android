...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final androidx.viewpager.widget.ViewPager viewPager = findViewById(R.id.view_pager);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ViewPager viewPagerA = new ViewPager(getSupportFragmentManager());
                int unread = 0;
                ...
                if(unread==0)
                    viewPagerA.addFragment(new ChatsFragment(), "CHATS");
                else
                    viewPagerA.addFragment(new ChatsFragment(), "CHATS ("+unread+")");
                viewPagerA.addFragment(new UsersFragment(), "CONTACTS");
                viewPagerA.addFragment(new ProfileFragment(), "ACCOUNT");
